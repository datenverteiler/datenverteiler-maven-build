[![Build Status](https://travis-ci.org/datenverteiler/datenverteiler-maven-plugins.svg?branch=master)](https://travis-ci.org/datenverteiler/datenverteiler-maven-plugins)
